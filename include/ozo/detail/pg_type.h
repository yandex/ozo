#pragma once
/**
* This file is abriged version of 
* https://github.com/postgres/postgres/blob/master/src/include/catalog/pg_type.h
*/

/**
* Not modified content begins below this comment. Information about built-in types.
* How to read OID is itself. Number after PGUID is a size of type in bytes. -1 for
* dynamic size types (e.g. string or array) or composite types. For more information\
